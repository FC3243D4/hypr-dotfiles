...
-- Default v2 (old-style) animation preset
...
hl.animation({ leaf = "borderangle", enabled = true, speed = 180, bezier = "linear", style = "loop" }) -- used by rainbow borders and rotating colors
