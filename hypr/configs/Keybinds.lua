...
hl.bind(mainMod .. " + G",                  hl.dsp.exec_cmd(scriptsDir .. "/GameMode.sh --polkit"),                                         { description = "toggle game mode" })
hl.bind(mainMod .. " + C",                  hl.dsp.exec_cmd(scriptsDir .. "/RofiCalc.sh"),                                                  { description = "calculator" })
hl.bind(mainMod .. " +Q",                   hl.dsp.window.close(),                                                                          { description = "close active window" })
hl.bind(mainMod .. " + Escape",             hl.dsp.exec_cmd(scriptsDir .. "/LockScreen.sh"),                                                { description = "lock screen" })
hl.bind(mainMod .. " + SHIFT + Escape",     hl.dsp.exec_cmd(scriptsDir .. "/Wlogout.sh"),                                                   { description = "powermenu" })
...
hl.bind(mainMod .. " + ALT + Tab",          hl.dsp.exec_cmd(scriptsDir .. "/WindowSwitcher.sh"),                            { description = "window switcher" })
hl.bind(mainMod .. " + CTRL + Tab",         hl.dsp.exec_cmd(scriptsDir .. "/OverviewToggle.sh"),                            { description = "desktop overview" })
...
---- WAYBAR / BAR RELATED ----
------------------------------
hl.bind(mainMod .. " + SHIFT + B",      hl.dsp.exec_cmd("if pgrep -x 'waybar' > /dev/null; systemctl --user stop waybar; else systemctl --user start waybar; fi"),      { description = "toggle waybar" })
...
hl.bind(mainMod .. " + CTRL + Print",           hl.dsp.exec_cmd(scriptsDir .."/ScreenShot.sh --area"),          { description = "Screenshot (area)" })
hl.bind(mainMod .. " + ALT + Print",            hl.dsp.exec_cmd(scriptsDir .."/ScreenShot.sh --in5"),           { description = "Screenshot in 5s" })
hl.bind(mainMod .." + CTRL + ALT + Print",      hl.dsp.exec_cmd(scriptsDir .."/ScreenShot.sh --in10"),          { description = "Screenshot in 10s" })
hl.bind(mainMod .. " + SHIFT + Print",          hl.dsp.exec_cmd(scriptsDir .."/ScreenShot.sh --active"),        { description = "Screenshot active window" })
...
-- Resize windows
hl.bind(mainMod .. " + ALT + SHIFT + left",         hl.dsp.window.resize({ x = -50, y = 0,  relative = true }),         { repeating = true, description = "Resize left (-50)" })
hl.bind(mainMod .. " + ALT + SHIFT + right",        hl.dsp.window.resize({ x = 50,  y = 0,  relative = true }),         { repeating = true, description = "Resize right (+50)" })
hl.bind(mainMod .. " + ALT + SHIFT + up",           hl.dsp.window.resize({ x = 0,   y = -50, relative = true }),        { repeating = true, description = "Resize up (-50)" })
hl.bind(mainMod .. " + ALT + SHIFT + down",         hl.dsp.window.resize({ x = 0,   y = 50,  relative = true }),        { repeating = true, description = "Resize down (+50)" })

-- Move to previous workspace --
--arrows
hl.bind(mainMod .. " + SHIFT + left",                   hl.dsp.window.move({ workspace = "-1" }),                { description = "Move to previous workspace" })
hl.bind(mainMod .. " + SHIFT + right",                  hl.dsp.window.move({ workspace = "+1" }),                { description = "Move to next workspace" })
hl.bind(mainMod .. " + CTRL + SHIFT + left",            hl.dsp.window.move({ workspace = "-1" }),                { description = "Move to previous workspace" })
hl.bind(mainMod .. " + CTRL + SHIFT + right",           hl.dsp.window.move({ workspace = "+1" }),                { description = "Move to next workspace" })
-- punctuation
hl.bind(mainMod .. " + SHIFT + comma",                  hl.dsp.window.move({ workspace = "-1" }),                { description = "Move to previous workspace" })
hl.bind(mainMod .. " + SHIFT + period",                 hl.dsp.window.move({ workspace = "+1" }),                { description = "Move to next workspace" })
hl.bind(mainMod .. " + CTRL + SHIFT + comma",           hl.dsp.window.move({ workspace = "-1" }),                { description = "Move to previous workspace" })
hl.bind(mainMod .. " + CTRL + SHIFT + period",          hl.dsp.window.move({ workspace = "+1" }),                { description = "Move to next workspace" })
--scroll
hl.bind(mainMod .. " + SHIFT + mouse_up",               hl.dsp.window.move({ workspace = "-1" }),                { description = "Move to previous workspace" })
hl.bind(mainMod .. " + SHIFT + mouse_down",             hl.dsp.window.move({ workspace = "+1" }),                { description = "Move to next workspace" })
hl.bind(mainMod .. " + CTRL + SHIFT + mouse_up",        hl.dsp.window.move({ workspace = "-1" }),                { description = "Move to previous workspace" })
hl.bind(mainMod .. " + CTRL + SHIFT + mouse_down",      hl.dsp.window.move({ workspace = "+1" }),                { description = "Move to next workspace" })

-- Move windows to workspaces with keys 1-0 and numpads
...
-- Switch workspaces with keys 1-0 and numpads
for _, entry in ipairs(wsKeyCodes) do
    local key = "code:" .. entry.code
    hl.bind(mainMod .. " + " .. key,              hl.dsp.focus({ workspace = entry.ws }),           { description = "Workspace " .. entry.ws })
end
...
hl.bind(mainMod .. " + CTRL + Tab",                     hl.dsp.group.next(),                                { description = "Change group forward" })
hl.bind(mainMod .. " + CTRL + SHIFT + Tab",             hl.dsp.group.next(),                                { description = "Change active in group" })
hl.bind(mainMod .. " + CTRL + ALT + SHIFT + Tab",       hl.dsp.group.prev(),                                { description = "Change group back" })
...
hl.bind(mainMod .. " + CTRL + I",               hl.dsp.layout("addmaster"),             { description = "Add master" })
